    ...
    return (
        ...
        >
            <Link href={`/projects/${id}`}>
                <Card className="relative overflow-hidden h-full border-border/50 dark:border-[#282e39] bg-surface-dark dark:bg-[#11141a]/80 backdrop-blur-md hover:border-primary/50 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/5 flex flex-col cursor-pointer">
                    {/* Image Section */}
